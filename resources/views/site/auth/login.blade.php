            ...
            <div class="col-sm-12 col-md-5 col-lg-5 pl-5">
                ...
                <form method="POST" action="{{ route('login') }}" autocomplete="off">
                    ...
                    <div class="form-group form-floating">
                        <input id="login" type="text" class="form-control @error('login') is-invalid @enderror" name="login" value="{{ old('login') }}" required autocomplete="off" id="floatingInput" placeholder="Email or phone">
                    ...
                    <div class="form-group form-floating">
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="off" id="floatingPassword" placeholder="Password">
