                ...
                <form action="{{route('register.submit')}}" method="POST" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control mt-3 @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required placeholder="First Name" id="first_name" autocomplete="off">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input id="last_name" type="text" class="form-control mt-3 @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required placeholder="Last Name" id="last_name" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <div class="form-floating">
                                <input id="email" type="email" class="form-control mt-3 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required placeholder="Email" id="email" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            <div class="form-floating">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required  placeholder="Password" Password>
                        ...
                        <div class="form-group col-6">
                            ...
                            placeholder="Password Confirm" id="password_confirmation">
                                <label for="password_confirmation">Password Confirm</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-floating">
                        <input class="form-control mt-3" type="tel" name="phone" placeholder="Phone"  id="phone" autocomplete="off" value="{{ old('phone') }}" >
